...
await conn.sendMessage(m.chat, { text: `🏰 *『 GUARDIÁN DEL GRUPO 』*

⚔️ ${user}, osaste compartir un *enlace prohibido*  
📜 Has roto el pacto sagrado de las normas.

💥 El castigo es la *expulsión inmediata* del reino.`, mentions: [m.sender] }, { quoted: m, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100 });
